...
public class TPCxIoT_IoTDB extends Thread {
  ...
  public TPCxIoT_IoTDB(int threadId, String deviceId, int insertNum) {
    ...
    try {
      ...
      for (int i = 0; i < insertNum; i++) {
        ...
        if (rand.nextInt(insertNum) <= (insertNum * 0.00002)) { // SCAN OPERATION
          ...
          result1 = scanHelper(deviceId, sensor, scanTimestamp);
  ...
  public Map<Long, String> scanHelper(String deviceId, String sensorId, long scanTimestamp)
      throws QueryProcessException, IOException, StorageEngineException, InterruptedException,
  ...
  public static void main(String[] args) throws Exception {
    ...
    TPCxIoT_IoTDB[] se = new TPCxIoT_IoTDB[threadNum];
    int totalNum = 100000;
    ...
    for (int i = 1; i <= threadNum; i++) {
      ...
      se[i - 1] = new TPCxIoT_IoTDB(i, deviceId, totalNum / threadNum);
      se[i - 1].start();
    }
